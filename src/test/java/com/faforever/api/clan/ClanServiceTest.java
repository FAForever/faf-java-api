...
public class ClanServiceTest {
  ...
  class TestGeneratePlayerInvitationToken {
    ...
    void success() throws Exception {
      ...
      assertThat("expire", captor.getValue().expire(), greaterThan(System.currentTimeMillis()));
  ...
  class TestAcceptPlayerInvitationToken {
    ...
    void expired() throws IOException {
      ...
      verifyNoInteractions(clanMembershipRepository);
    }
    ...
    @Test
    void invalidPlayer() throws IOException {
    ...
    @Test
    void playerInTokenNotLoggedInPlayer() throws IOException {
      Player newMember = new Player();
      newMember.setId(2);
    ...
    @Test
    void playerIsAlreadyInClan() throws IOException {
      Player newMember = new Player();
      newMember.setId(2);
