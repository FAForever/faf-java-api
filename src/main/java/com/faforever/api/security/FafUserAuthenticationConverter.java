...
public class FafUserAuthenticationConverter extends DefaultUserAuthenticationConverter {
  ...
  public FafUserAuthenticationConverter(PermissionService permissionService) {
  ...
  public Authentication extractAuthentication(Map<String, ?> map) {
    ...
    UserDetails user = new FafUserDetails(id, username, "N/A", accountNonLocked, authorities, permissionService);
